...
public class ServerUtils {
    ...
    public static Map<String,Object> getRequestInfo(HttpServletRequest request){
        ...
        requestInfo.put("city",IpUtils.getHttpCityInfo(ip));
        requestInfo.put("browser", IpUtils.getBrowser(request));
        return requestInfo;
    }
    ...
    public static Map<String,Object> getSystemInfo(OperatingSystem os){
        ...
        // 计算项目运行时间
        //long millis=DateUtil.between(date,new Date(), DateUnit.MS);
        //String formatBetween = DateUtil.formatBetween(millis, BetweenFormater.Level.SECOND);
